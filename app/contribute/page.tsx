...
export default function ContributePage() {
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      ...
      <p>
        Submit a pre-1930 source, earliest attestation, translation, or correction.
        We review for accuracy and add it to the catalog.
      </p>
      ...
      {!submitted ? (
        ...
        >
          ...
          <div>
            <label>Year (≤ 1930 preferred)</label>
            <input className="input mt-1" type="number" min={0} />
          </div>

          <div>
            <label>Details / Page Numbers / Notes</label>
